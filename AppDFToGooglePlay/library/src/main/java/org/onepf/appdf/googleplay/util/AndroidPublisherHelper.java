...
public class AndroidPublisherHelper {
    ...
    private static Credential authorizeWithServiceAccount(String serviceAccountEmail)
        ...
        return new GoogleCredential.Builder()
                ...
                .setServiceAccountPrivateKeyFromP12File(new File(AndroidPublisherHelper.class.getResource(SRC_RESOURCES_KEY_P12).toURI()))
                .build();
    }
    ...
    private static Credential authorizeWithInstalledApplication() throws IOException {
        ...
        GoogleAuthorizationCodeFlow flow = new GoogleAuthorizationCodeFlow
                ...
                JSON_FACTORY,
                clientSecrets,
                Collections.singleton(AndroidPublisherScopes.ANDROIDPUBLISHER)).setDataStoreFactory(dataStoreFactory).build();
        // authorize
